...
| <a name="input_enable_advanced_security"></a> [enable\_advanced\_security](#input\_enable\_advanced\_security) | Enable GitHub Advanced Security features (requires GitHub Enterprise). | `bool` | `false` | no |
| <a name="input_enable_branch_protection_rulesets"></a> [enable\_branch\_protection\_rulesets](#input\_enable\_branch\_protection\_rulesets) | Enable branch protection rulesets (requires GitHub Pro for private repos). Set to false for GitHub Free plans. | `bool` | `true` | no |
